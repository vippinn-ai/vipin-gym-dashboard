...
export function Training() {
  ...
  return <div className="page">
    <PageIntro eyebrow="267 source-linked entries" title="The complete training journal.">Every set remains comparable only within its recorded load basis. Filters never rewrite history.</PageIntro>
